...
## cd [path](#file-path) - Change Directory <a name="#cd"></a>
...
## npm init -y <a name="#npm-init-y"></a>
...
## npm install <a name="#npm-install"></a>

...

### npm install -D <a name="#npm-install-d"></a>

...

### npm uninstall <a name="#npm-uninstall"></a>

...

### npm run <a name="#npm-run"></a>

...

### tsc --init <a name="#tsc-init"></a>
