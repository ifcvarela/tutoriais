...
Nesta aula foi utilizado o tutorial [CRUD Simples - Nodejs (express, typescript) - single server](--tutorial---crud_restapi_single_domain---nodejs,typescript,express,sqlite.md) como base para a revisão de conceitos e apresentação de novos conceitos.
